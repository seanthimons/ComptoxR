...
-   collapse list-columns to semicolon-separated strings in
    safe_tidy_bind
...
-   update to schema and servers; will now try all servers and allows
    for fallback to development to generate endpoint lists.
...
-   remove remaining toxval_server()/toxval_path() double-call patterns
    in test files
...
-   expand gitleaks workflow triggers - Add scheduled runs (Mon, Wed,
    Fri at 9am UTC) - Include integration branch in push/PR triggers
