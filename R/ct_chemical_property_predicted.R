...
#' @examples
#' \dontrun{
#' ct_chemical_property_predicted_bulk(query = "DTXSID7020182")
#' }
ct_chemical_property_predicted_bulk <- function(query) {
...
#' }
ct_chemical_property_predicted <- function(dtxsid) {
  result <- generic_request(
    query = dtxsid,
    endpoint = "chemical/property/predicted/search/by-dtxsid/",
    method = "GET",
