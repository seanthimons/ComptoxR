...
#' @examples
#' \dontrun{
#' ct_chemical_detail_by_dtxcid_bulk(query = "DTXSID7020182")
#' }
ct_chemical_detail_by_dtxcid_bulk <- function(query, projection = "chemicaldetailall") {
...
#' @examples
#' \dontrun{
#' ct_chemical_detail_by_dtxcid(dtxcid = "DTXCID505")
#' }
ct_chemical_detail_by_dtxcid <- function(dtxcid, projection = "chemicaldetailall") {
  result <- generic_request(
    query = dtxcid,
    endpoint = "chemical/detail/search/by-dtxcid/",
    method = "GET",
