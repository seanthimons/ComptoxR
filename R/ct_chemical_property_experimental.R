...
#' @examples
#' \dontrun{
#' ct_chemical_property_experimental_bulk(query = "DTXSID7020182")
#' }
ct_chemical_property_experimental_bulk <- function(query) {
...
#' }
ct_chemical_property_experimental <- function(dtxsid) {
  result <- generic_request(
    query = dtxsid,
    endpoint = "chemical/property/experimental/search/by-dtxsid/",
    method = "GET",
