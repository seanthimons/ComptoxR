...
#' @examples
#' \dontrun{
#' chemi_amos_substances_for_classification_development(kingdom = "DTXSID1024122")
#' }
chemi_amos_substances_for_classification_development <- function(kingdom = NULL, klass = NULL, subklass = NULL, superklass = NULL) {
  server <- "chemi_burl"
  req_data <- run_hook("chemi_amos_substances_for_classification_development", "pre_request", list(params = list(`kingdom` = kingdom, `klass` = klass, `subklass` = subklass, `superklass` = superklass, `server` = server)))
