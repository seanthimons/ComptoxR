...
#' @param offset Offset of the records to return.
...
#' @examples
#' \dontrun{
#' chemi_amos_analytical_qc_pagination(limit = "DTXSID7020182")
#' }
chemi_amos_analytical_qc_pagination <- function(limit, offset = 0, all_pages = TRUE, max_pages = 100) {
  server <- "chemi_burl"
  req_data <- run_hook(
