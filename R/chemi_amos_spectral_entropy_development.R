...
#' @examples
#' \dontrun{
#' chemi_amos_spectral_entropy_development(spectrum = "DTXSID1024122")
#' }
chemi_amos_spectral_entropy_development <- function(spectrum = NULL) {
  server <- "chemi_burl"
  req_data <- run_hook("chemi_amos_spectral_entropy_development", "pre_request", list(params = list(`spectrum` = spectrum, `server` = server)))
