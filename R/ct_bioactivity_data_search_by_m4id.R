...
#' }
ct_bioactivity_data_search_by_m4id_bulk <- function(query, annotate = FALSE) {
  ...
  result <- run_hook("ct_bioactivity_data_search_by_m4id_bulk", "post_response", list(result = result, params = list(annotate = annotate)))
