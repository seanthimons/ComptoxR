...
#' @examples
#' \dontrun{
#' chemi_resolver_resolver_exportsimilaritylist(query = "DTXSID7020182")
#' }
chemi_resolver_resolver_exportsimilaritylist <- function(query, format = NULL, showImage = NULL, limit = NULL) {
  ...
  generic_chemi_request(
    query = query,
    endpoint = "api/resolver/exportsimilaritylist",
    server = "chemi_burl",
    auth = FALSE,
    options = options
  )
