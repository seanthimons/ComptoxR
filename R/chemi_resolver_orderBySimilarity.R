...
#' @examples
#' \dontrun{
#' chemi_resolver_orderBySimilarity(chemicals = "DTXSID7020182")
#' }
chemi_resolver_orderBySimilarity <- function(chemicals, fingerprintName = NULL, get_chemicals = NULL, main = NULL, padelCompute2D = NULL, padelCompute3D = NULL, padelComputeFingerprints = NULL, rdkitBits = NULL, rdkitRadius = NULL, rdkitType = NULL, scoreName = NULL, toxprintsProfile = NULL, tverskyI = NULL) {
