...
#' @examples
#' \dontrun{
#' chemi_amos_amos_fact_sheet_pagination(query = "DTXSID7020182")
#' }
chemi_amos_amos_fact_sheet_pagination <- function(query, offset = NULL) {
  ...
  generic_chemi_request(
    query = query,
    endpoint = "api/amos/fact_sheet_pagination/",
    server = "chemi_burl",
    auth = FALSE,
    options = options
  )
