...
ct_exposure_mmdb_aggregate_by_medium <- function(medium, pageNumber = 1, all_pages = TRUE, max_pages = 100) {
  params <- base::list("medium" = medium, "pageNumber" = pageNumber, "all_pages" = all_pages, "max_pages" = max_pages)
