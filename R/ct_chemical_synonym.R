...
#' @examples
#' \dontrun{
#' ct_chemical_synonym_bulk(query = "DTXSID7020182")
#' }
ct_chemical_synonym_bulk <- function(query) {
...
#' @examples
#' \dontrun{
#' ct_chemical_synonym(dtxsid = "DTXSID7020182")
#' }
ct_chemical_synonym <- function(dtxsid, projection = NULL) {
  result <- generic_request(
    query = dtxsid,
    endpoint = "chemical/synonym/search/by-dtxsid/",
    method = "GET",
