...
#' @examples
#' \dontrun{
#' chemi_amos_substances_for_ids_development(internal_id_list = "DTXSID1024122")
#' }
chemi_amos_substances_for_ids_development <- function(internal_id_list = NULL) {
  server <- "chemi_burl"
  req_data <- run_hook("chemi_amos_substances_for_ids_development", "pre_request", list(params = list(`internal_id_list` = internal_id_list, `server` = server)))
