...
#' @examples
#' \dontrun{
#' chemi_amos_get_similar_structures_by_dtxsid(dtxsid = "DTXSID7020182")
#' }
chemi_amos_get_similar_structures_by_dtxsid <- function(dtxsid) {
  server <- "chemi_burl"
  req_data <- run_hook(
    "chemi_amos_get_similar_structures_by_dtxsid",
    "pre_request",
