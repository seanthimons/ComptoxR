...
#' @examples
#' \dontrun{
#' ct_bioactivity_assay_by_aeid_bulk(query = "DTXSID7020182")
#' }
ct_bioactivity_assay_by_aeid_bulk <- function(query) {
...
#' @examples
#' \dontrun{
#' ct_bioactivity_assay_by_aeid(aeid = "3032")
#' }
ct_bioactivity_assay_by_aeid <- function(aeid, projection = NULL) {
  result <- generic_request(
    query = aeid,
    endpoint = "bioactivity/assay/search/by-aeid/",
    method = "GET",
