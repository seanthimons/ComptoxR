...
#' @examples
#' \dontrun{
#' chemi_amos_batch_development(additional_record_info = "DTXSID1024122")
#' }
chemi_amos_batch_development <- function(additional_record_info = NULL, always_download_file = NULL, base_url = NULL, identifiers = NULL, include_classyfire = NULL, include_external_links = NULL, include_functional_uses = NULL, include_source_counts = NULL, methodologies = NULL, record_types = NULL) {
  server <- "chemi_burl"
  req_data <- run_hook("chemi_amos_batch_development", "pre_request", list(params = list(`additional_record_info` = additional_record_info, `always_download_file` = always_download_file, `base_url` = base_url, `identifiers` = identifiers, `include_classyfire` = include_classyfire, `include_external_links` = include_external_links, `include_functional_uses` = include_functional_uses, `include_source_counts` = include_source_counts, `methodologies` = methodologies, `record_types` = record_types, `server` = server)))
