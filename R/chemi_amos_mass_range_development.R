...
#' @examples
#' \dontrun{
#' chemi_amos_mass_range_development(lower_mass_limit = "DTXSID1024122")
#' }
chemi_amos_mass_range_development <- function(lower_mass_limit = NULL, upper_mass_limit = NULL) {
  server <- "chemi_burl"
  req_data <- run_hook("chemi_amos_mass_range_development", "pre_request", list(params = list(`lower_mass_limit` = lower_mass_limit, `upper_mass_limit` = upper_mass_limit, `server` = server)))
