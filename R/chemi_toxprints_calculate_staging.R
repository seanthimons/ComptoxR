...
#' @examples
#' \dontrun{
#' chemi_toxprints_calculate_bulk_staging(query = c("50-00-0", "DTXSID7020182"))
#' }
chemi_toxprints_calculate_bulk_staging <- function(
  query,
  idType = "AnyId",
  labels = NULL,
  options = NULL,
  ...
  server <- "chemi_burl"
  req_data <- run_hook(
    "chemi_toxprints_calculate_bulk_staging",
    "pre_request",
    list(
      params = list(
        `query` = query,
