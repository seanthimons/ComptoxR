#' Get observations by Study Type
#'
#' @description
...
#' @examples
#' \dontrun{
#' ct_hazard_toxref_observations_search_by_study_type(studyType = "DEV")
#' }
ct_hazard_toxref_observations_search_by_study_type <- function(studyType, pageNumber = 1, all_pages = TRUE) {
