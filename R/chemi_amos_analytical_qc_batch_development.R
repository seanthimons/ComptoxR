...
#' @examples
#' \dontrun{
#' chemi_amos_analytical_qc_batch_development(base_url = "DTXSID1024122")
#' }
chemi_amos_analytical_qc_batch_development <- function(base_url = NULL, identifiers = NULL, include_classyfire = NULL, include_functional_uses = NULL, include_source_counts = NULL, methodologies = NULL) {
  server <- "chemi_burl"
  req_data <- run_hook("chemi_amos_analytical_qc_batch_development", "pre_request", list(params = list(`base_url` = base_url, `identifiers` = identifiers, `include_classyfire` = include_classyfire, `include_functional_uses` = include_functional_uses, `include_source_counts` = include_source_counts, `methodologies` = methodologies, `server` = server)))
