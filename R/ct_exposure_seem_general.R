...
#' @examples
#' \dontrun{
#' ct_exposure_seem_general_bulk(query = "DTXSID7020182")
#' }
ct_exposure_seem_general_bulk <- function(query) {
...
#' @examples
#' \dontrun{
#' ct_exposure_seem_general(dtxsid = "DTXSID0020232")
#' }
ct_exposure_seem_general <- function(dtxsid, projection = NULL) {
  result <- generic_request(
    query = dtxsid,
    endpoint = "exposure/seem/general/search/by-dtxsid/",
    method = "GET",
