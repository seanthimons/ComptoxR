...
#' @examples
#' \dontrun{
#' ct_exposure_seem_demographic_bulk(query = "DTXSID7020182")
#' }
ct_exposure_seem_demographic_bulk <- function(query) {
...
#' @examples
#' \dontrun{
#' ct_exposure_seem_demographic(dtxsid = "DTXSID0020232")
#' }
ct_exposure_seem_demographic <- function(dtxsid, projection = NULL) {
  result <- generic_request(
    query = dtxsid,
    endpoint = "exposure/seem/demographic/search/by-dtxsid/",
    method = "GET",
