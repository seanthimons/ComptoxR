...
#' @examples
#' \dontrun{
#' ct_chemical_detail_search_bulk(query = c("DTXSID2042353", "DTXSID50182047", "DTXSID7043792"))
#' }
ct_chemical_detail_search_bulk <- function(query, projection = "chemicaldetailall") {
