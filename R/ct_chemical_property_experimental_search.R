...
#' }
ct_chemical_property_experimental_search_bulk <- function(query, coerce = FALSE) {
  ...
  result <- run_hook("ct_chemical_property_experimental_search_bulk", "post_response", list(result = result, params = list(coerce = coerce)))
