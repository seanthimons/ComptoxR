...
#' @examples
#' \dontrun{
#' chemi_amos_entropy_similarity_development(spectrum_1 = "DTXSID1024122")
#' }
chemi_amos_entropy_similarity_development <- function(spectrum_1 = NULL, spectrum_2 = NULL, type = NULL, window = NULL) {
  server <- "chemi_burl"
  req_data <- run_hook("chemi_amos_entropy_similarity_development", "pre_request", list(params = list(`spectrum_1` = spectrum_1, `spectrum_2` = spectrum_2, `type` = type, `window` = window, `server` = server)))
