...
#' @examples
#' \dontrun{
#' ct_chemical_detail_bulk(query = "DTXSID7020182")
#' }
ct_chemical_detail_bulk <- function(query, projection = "chemicaldetailall") {
...
#' @examples
#' \dontrun{
#' ct_chemical_detail(dtxsid = "DTXSID7020182")
#' }
ct_chemical_detail <- function(dtxsid, projection = "chemicaldetailall") {
  result <- generic_request(
    query = dtxsid,
    endpoint = "chemical/detail/search/by-dtxsid/",
    method = "GET",
