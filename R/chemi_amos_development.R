...
#' @examples
#' \dontrun{
#' chemi_amos_development(dtxsid = "DTXSID7020182")
#' }
chemi_amos_development <- function(dtxsid) {
  server <- "chemi_burl"
  req_data <- run_hook("chemi_amos_development", "pre_request", list(params = list(`dtxsid` = dtxsid, `server` = server)))
