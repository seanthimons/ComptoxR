...
A common, initial step for hazard identification is screening by physio-chemical properties. The 

```{r Properties search, echo=TRUE}
#| include: true

ct_prop(query = dtx_list, debug = FALSE)

```

#### Hazard Comparison

Following the logic outlined by \[citation\]

#### Generalized Read-Across (GenRA) and ToxPrint Enrichment

#### Non-Targeted Analysis Compound Searching

#### Querying Names and Supported Identifiers
