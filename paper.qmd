...
author: "Sean Thimons, Antony Williams"
prefer-html: true
format: docx
...
df_names <- ct_details(query = dtx_list[c(1,7:10,29)]) %>% select(dtxsid, preferredName)
