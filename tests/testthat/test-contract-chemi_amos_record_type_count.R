...
testthat::test_that("chemi_amos_record_type_count completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_amos_record_type_count"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_record_type_count, contract$inputs)
