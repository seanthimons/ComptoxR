...
test_that("chemi_hazard passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_hazard(query = "DTXSID7020182"))), silent = TRUE)
