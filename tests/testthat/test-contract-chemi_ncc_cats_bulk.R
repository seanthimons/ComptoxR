...
testthat::test_that("chemi_ncc_cats_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_ncc_cats_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_ncc_cats_bulk, contract$inputs)
