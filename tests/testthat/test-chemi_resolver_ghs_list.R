# Tests for chemi_resolver_ghs_list
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_resolver_ghs_list passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_resolver_ghs_list(name = "DTXSID7020182"))),
    silent = TRUE
  )
  ...
  expect_equal(call[["endpoint"]], "resolver/ghs-list")
