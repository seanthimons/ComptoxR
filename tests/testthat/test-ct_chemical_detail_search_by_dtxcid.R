...
test_that("ct_chemical_detail_search_by_dtxcid passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_chemical_detail_search_by_dtxcid(dtxcid = "DTXCID30182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "chemical/detail/search/by-dtxcid/")
