# Tests for ct_hazard_skin_eye_search_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("ct_hazard_skin_eye_search_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_hazard_skin_eye_search_bulk(query = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "hazard/skin-eye/search/by-dtxsid/")
