...
testthat::test_that("epi_submit completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/epi.rds"))[["epi_submit"]]
  ...
  result <- do.call(ComptoxR::epi_submit, contract$inputs)
