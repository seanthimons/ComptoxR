...
testthat::test_that("ct_hazard_toxref_effects_search_by_study_type completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_hazard_toxref_effects_search_by_study_type"
  ]]
  ...
  result <- do.call(ComptoxR::ct_hazard_toxref_effects_search_by_study_type, contract$inputs)
