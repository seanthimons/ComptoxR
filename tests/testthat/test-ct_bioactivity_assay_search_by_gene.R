...
test_that("ct_bioactivity_assay_search_by_gene passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_bioactivity_assay_search_by_gene(geneSymbol = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "bioactivity/assay/search/by-gene/")
