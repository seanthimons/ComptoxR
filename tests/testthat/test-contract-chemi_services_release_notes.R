...
testthat::test_that("chemi_services_release_notes completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-services.rds"))[["chemi_services_release_notes"]]
  ...
  result <- do.call(ComptoxR::chemi_services_release_notes, contract$inputs)
