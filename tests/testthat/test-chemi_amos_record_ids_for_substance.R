# Tests for chemi_amos_record_ids_for_substance
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_record_ids_for_substance passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_amos_record_ids_for_substance(dtxsid = "DTXSID7020182"))),
    silent = TRUE
  )
