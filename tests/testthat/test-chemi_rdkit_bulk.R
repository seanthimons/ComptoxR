...
test_that("chemi_rdkit_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_rdkit_bulk(chemicals = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "rdkit")
