...
testthat::test_that("ct_hazard_toxref_effects_search completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_hazard_toxref_effects_search"
  ]]
  ...
  result <- do.call(ComptoxR::ct_hazard_toxref_effects_search, contract$inputs)
