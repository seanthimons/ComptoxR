...
testthat::test_that("chemi_resolver_ghs_list_count completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-resolver.rds"))[["chemi_resolver_ghs_list_count"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_ghs_list_count, contract$inputs)
