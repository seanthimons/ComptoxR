# Tests for chemi_alerts_groups_bulk_staging
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_alerts_groups_bulk_staging passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_alerts_groups_bulk_staging())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "alerts/groups")
