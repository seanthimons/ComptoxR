...
testthat::test_that("chemi_amnb_nate_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_amnb_nate_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_amnb_nate_bulk, contract$inputs)
