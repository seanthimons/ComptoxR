...
testthat::test_that("chemi_chet_chemicals_image completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-chet.rds"))[["chemi_chet_chemicals_image"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_chemicals_image, contract$inputs)
