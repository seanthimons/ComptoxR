# Tests for epi_ecosar_surfactant
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("epi_ecosar_surfactant passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::epi_ecosar_surfactant(type = "DTXSID7020182"))),
    silent = TRUE
  )
  ...
  expect_equal(call[["endpoint"]], "ecosar/surfactant")
