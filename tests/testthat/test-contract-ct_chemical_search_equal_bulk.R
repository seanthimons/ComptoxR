...
testthat::test_that("ct_chemical_search_equal_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_chemical_search_equal_bulk"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_search_equal_bulk, contract$inputs)
