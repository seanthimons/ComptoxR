# Tests for ct_chemical_property_summary_experimental_search
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("ct_chemical_property_summary_experimental_search passes request metadata to helper", {
