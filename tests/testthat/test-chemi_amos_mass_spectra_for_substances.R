...
test_that("chemi_amos_mass_spectra_for_substances passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_mass_spectra_for_substances())), silent = TRUE)
