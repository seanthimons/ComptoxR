...
testthat::test_that("chemi_amos_mass_spectrum_similarity completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_mass_spectrum_similarity"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_mass_spectrum_similarity, contract$inputs)
