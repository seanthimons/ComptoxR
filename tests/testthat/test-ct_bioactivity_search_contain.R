...
test_that("ct_bioactivity_search_contain passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_bioactivity_search_contain(value = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "bioactivity/search/contain/")
