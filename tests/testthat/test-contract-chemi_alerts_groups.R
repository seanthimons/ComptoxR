...
testthat::test_that("chemi_alerts_groups completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-alerts.rds"))[["chemi_alerts_groups"]]
  ...
  result <- do.call(ComptoxR::chemi_alerts_groups, contract$inputs)
