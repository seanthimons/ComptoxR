...
testthat::test_that("chemi_resolver_getsubstance completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_resolver_getsubstance"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_getsubstance, contract$inputs)
