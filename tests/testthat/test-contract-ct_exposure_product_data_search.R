...
testthat::test_that("ct_exposure_product_data_search completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["ct_exposure_product_data_search"]]
  ...
  result <- do.call(ComptoxR::ct_exposure_product_data_search, contract$inputs)
