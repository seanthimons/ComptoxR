...
testthat::test_that("chemi_padel_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-padel.rds"))[["chemi_padel_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_padel_bulk, contract$inputs)
