...
testthat::test_that("ct_chemical_list_all completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-pilot-contracts.rds"))[["ct_chemical_list_all"]]
  captured <- list()
  ...
  result <- do.call(ComptoxR::ct_chemical_list_all, contract$inputs)
