...
testthat::test_that("chemi_resolver_ccte_lists completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-resolver.rds"))[["chemi_resolver_ccte_lists"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_ccte_lists, contract$inputs)
