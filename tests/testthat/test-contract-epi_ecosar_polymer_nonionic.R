...
testthat::test_that("epi_ecosar_polymer_nonionic completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/epi.rds"))[["epi_ecosar_polymer_nonionic"]]
  ...
  result <- do.call(ComptoxR::epi_ecosar_polymer_nonionic, contract$inputs)
