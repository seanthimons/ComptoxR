...
testthat::test_that("chemi_amos_retrieve_fact_sheets completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_retrieve_fact_sheets"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_retrieve_fact_sheets, contract$inputs)
