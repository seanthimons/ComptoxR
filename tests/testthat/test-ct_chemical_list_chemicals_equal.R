...
test_that("ct_chemical_list_chemicals_equal works with valid input", 
    {
        vcr::use_cassette("ct_chemical_list_chemicals_equal_query", 
            {
                result <- ct_chemical_list_chemicals_equal(query = "DTXSID7020182")
                {
...
test_that("ct_chemical_list_chemicals_equal handles batch requests", 
    {
        vcr::use_cassette("ct_chemical_list_chemicals_equal_batch", 
            {
                result <- ct_chemical_list_chemicals_equal(query = c("DTXSID7020182", 
                "DTXSID5032381"))
                expect_s3_class(result, "tbl_df")
...
test_that("ct_chemical_list_chemicals_equal handles invalid input gracefully", 
    {
        vcr::use_cassette("ct_chemical_list_chemicals_equal_error", 
            {
                expect_warning(result <- ct_chemical_list_chemicals_equal(query = "INVALID_ID"))
