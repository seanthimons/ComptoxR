# Tests for chemi_chet_reaction_database_old_by_pagenum_and_searchterm
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_chet_reaction_database_old_by_pagenum_and_searchterm passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_chet_reaction_database_old_by_pagenum_and_searchterm(
      pagenum = 1L
    ))),
    silent = TRUE
  )
