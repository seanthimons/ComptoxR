...
testthat::test_that("chemi_predictor_models_predict completes the fixed call sequence", {
  ...
  result <- do.call(ComptoxR::chemi_predictor_models_predict, contract$inputs)
