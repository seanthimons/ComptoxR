# Tests for chemi_chet_reaction_searchcounts
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_chet_reaction_searchcounts passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_chet_reaction_searchcounts(search_input = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "reaction/searchcounts/")
