...
testthat::test_that("chemi_ncc_cats completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_ncc_cats"]]
  ...
  result <- do.call(ComptoxR::chemi_ncc_cats, contract$inputs)
