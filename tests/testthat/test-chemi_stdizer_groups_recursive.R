...
test_that("chemi_stdizer_groups_recursive passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_stdizer_groups_recursive(id = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "stdizer/groups/recursive")
