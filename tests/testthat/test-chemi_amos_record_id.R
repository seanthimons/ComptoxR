...
test_that("chemi_amos_record_id passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_record_id(internal_id = 1L))), silent = TRUE)
