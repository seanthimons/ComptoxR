# Tests for chemi_chet_reaction_batchsearch
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_chet_reaction_batchsearch passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_chet_reaction_batchsearch(dtxsids = "DTXSID7020182", search_level = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "reaction/batchsearch")
