...
testthat::test_that("chemi_alerts completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-alerts.rds"))[["chemi_alerts"]]
  ...
  result <- do.call(ComptoxR::chemi_alerts, contract$inputs)
