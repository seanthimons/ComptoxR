...
testthat::test_that("chemi_rdkit completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-rdkit.rds"))[["chemi_rdkit"]]
  ...
  result <- do.call(ComptoxR::chemi_rdkit, contract$inputs)
