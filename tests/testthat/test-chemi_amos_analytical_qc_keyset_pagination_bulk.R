# Tests for chemi_amos_analytical_qc_keyset_pagination_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_analytical_qc_keyset_pagination_bulk passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_amos_analytical_qc_keyset_pagination_bulk(limit = 1L))),
    silent = TRUE
  )
