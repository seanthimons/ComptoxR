...
testthat::test_that("chemi_resolver_hcodes completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-resolver.rds"))[["chemi_resolver_hcodes"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_hcodes, contract$inputs)
