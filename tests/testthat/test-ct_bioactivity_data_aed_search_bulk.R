# Tests for ct_bioactivity_data_aed_search_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("ct_bioactivity_data_aed_search_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_bioactivity_data_aed_search_bulk(query = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "bioactivity/data/aed/search/by-dtxsid/")
