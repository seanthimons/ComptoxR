...
testthat::test_that("chemi_resolver_orderBySimilarity completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-resolver.rds"))[["chemi_resolver_orderBySimilarity"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_orderBySimilarity, contract$inputs)
