...
testthat::test_that("chemi_chet_reaction_dbcounts completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_chet_reaction_dbcounts"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_reaction_dbcounts, contract$inputs)
