...
test_that("chemi_amos_inchikey_first_block passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_inchikey_first_block(first_block = "DTXSID7020182"))), silent = TRUE)
