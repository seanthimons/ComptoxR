...
testthat::test_that("chemi_resolver_pubchem_section_bulk completes the fixed call sequence", {
  ...
  result <- do.call(ComptoxR::chemi_resolver_pubchem_section_bulk, contract$inputs)
