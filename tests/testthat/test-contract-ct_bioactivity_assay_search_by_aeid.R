...
testthat::test_that("ct_bioactivity_assay_search_by_aeid completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_bioactivity_assay_search_by_aeid"
  ]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_assay_search_by_aeid, contract$inputs)
