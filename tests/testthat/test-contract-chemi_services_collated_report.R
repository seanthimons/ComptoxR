...
testthat::test_that("chemi_services_collated_report completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-services.rds"))[["chemi_services_collated_report"]]
  ...
  result <- do.call(ComptoxR::chemi_services_collated_report, contract$inputs)
