...
test_that("chemi_amos_get_ir_spectrum passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_get_ir_spectrum(internal_id = 1L))), silent = TRUE)
