...
testthat::test_that("chemi_padel completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-padel.rds"))[["chemi_padel"]]
  ...
  result <- do.call(ComptoxR::chemi_padel, contract$inputs)
