# Tests for chemi_amos_mass_range_staging
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_mass_range_staging passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_mass_range_staging())), silent = TRUE)
