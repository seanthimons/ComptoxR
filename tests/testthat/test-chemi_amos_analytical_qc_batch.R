...
test_that("chemi_amos_analytical_qc_batch passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_analytical_qc_batch())), silent = TRUE)
