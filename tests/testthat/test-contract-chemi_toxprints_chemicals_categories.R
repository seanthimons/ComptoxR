...
testthat::test_that("chemi_toxprints_chemicals_categories completes the fixed call sequence", {
  ...
  result <- do.call(ComptoxR::chemi_toxprints_chemicals_categories, contract$inputs)
