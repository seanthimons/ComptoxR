...
test_that("chemi_services_smirks2rxn passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_services_smirks2rxn(smirks = "DTXSID7020182"))), silent = TRUE)
