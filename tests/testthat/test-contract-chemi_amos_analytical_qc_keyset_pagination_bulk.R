...
testthat::test_that("chemi_amos_analytical_qc_keyset_pagination_bulk completes the fixed call sequence", {
  ...
  result <- do.call(ComptoxR::chemi_amos_analytical_qc_keyset_pagination_bulk, contract$inputs)
