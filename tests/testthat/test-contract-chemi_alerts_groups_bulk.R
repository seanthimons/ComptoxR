...
testthat::test_that("chemi_alerts_groups_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-alerts.rds"))[["chemi_alerts_groups_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_alerts_groups_bulk, contract$inputs)
