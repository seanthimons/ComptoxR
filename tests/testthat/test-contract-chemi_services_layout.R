...
testthat::test_that("chemi_services_layout completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_services_layout"]]
  ...
  result <- do.call(ComptoxR::chemi_services_layout, contract$inputs)
