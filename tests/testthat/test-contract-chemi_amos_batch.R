...
testthat::test_that("chemi_amos_batch completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_batch"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_batch, contract$inputs)
