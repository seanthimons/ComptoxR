# Tests for chemi_amos_list_sources_by_record_type_development
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_list_sources_by_record_type_development passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_list_sources_by_record_type_development(record_type = "DTXSID7020182"))), silent = TRUE)
