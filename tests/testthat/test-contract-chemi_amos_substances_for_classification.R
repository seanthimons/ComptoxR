...
testthat::test_that("chemi_amos_substances_for_classification completes the fixed call sequence", {
  ...
  result <- do.call(ComptoxR::chemi_amos_substances_for_classification, contract$inputs)
