# Tests for ct_chemical_list_chemicals_search_start_with
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("ct_chemical_list_chemicals_search_start_with passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_chemical_list_chemicals_search_start_with(list = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "chemical/list/chemicals/search/start-with/")
