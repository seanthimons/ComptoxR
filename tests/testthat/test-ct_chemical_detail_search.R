...
test_that("ct_chemical_detail_search passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_chemical_detail_search(dtxsid = "DTXSID7020182"))), silent = TRUE)
