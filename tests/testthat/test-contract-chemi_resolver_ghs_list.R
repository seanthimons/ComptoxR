...
testthat::test_that("chemi_resolver_ghs_list completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_resolver_ghs_list"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_ghs_list, contract$inputs)
