...
testthat::test_that("epi_ecosar_dye completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/epi.rds"))[["epi_ecosar_dye"]]
  ...
  result <- do.call(ComptoxR::epi_ecosar_dye, contract$inputs)
