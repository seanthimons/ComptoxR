...
testthat::test_that("chemi_amos_get_product_declaration_editor_info completes the fixed call sequence", {
  ...
  result <- do.call(ComptoxR::chemi_amos_get_product_declaration_editor_info, contract$inputs)
