...
testthat::test_that("chemi_resolver_lookup completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-resolver.rds"))[["chemi_resolver_lookup"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_lookup, contract$inputs)
