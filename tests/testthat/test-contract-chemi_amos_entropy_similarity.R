...
testthat::test_that("chemi_amos_entropy_similarity completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_entropy_similarity"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_entropy_similarity, contract$inputs)
