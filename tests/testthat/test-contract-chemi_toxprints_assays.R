...
testthat::test_that("chemi_toxprints_assays completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-toxprints.rds"))[["chemi_toxprints_assays"]]
  ...
  result <- do.call(ComptoxR::chemi_toxprints_assays, contract$inputs)
