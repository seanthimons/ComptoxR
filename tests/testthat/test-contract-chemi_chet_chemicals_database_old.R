...
testthat::test_that("chemi_chet_chemicals_database_old completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-chet.rds"))[["chemi_chet_chemicals_database_old"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_chemicals_database_old, contract$inputs)
