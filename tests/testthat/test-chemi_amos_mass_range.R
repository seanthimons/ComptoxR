...
test_that("chemi_amos_mass_range passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_mass_range())), silent = TRUE)
