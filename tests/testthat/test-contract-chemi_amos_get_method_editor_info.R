...
testthat::test_that("chemi_amos_get_method_editor_info completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[[
    "chemi_amos_get_method_editor_info"
  ]]
  ...
  result <- do.call(ComptoxR::chemi_amos_get_method_editor_info, contract$inputs)
