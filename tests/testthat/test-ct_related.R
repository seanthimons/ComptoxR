...
test_that("ct_related passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_related(query = "DTXSID7020182"))), silent = TRUE)
