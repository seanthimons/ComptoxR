...
test_that("chemi_stdizer_records passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_stdizer_records())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "stdizer/records")
