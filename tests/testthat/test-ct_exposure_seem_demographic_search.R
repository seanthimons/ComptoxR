...
test_that("ct_exposure_seem_demographic_search passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_exposure_seem_demographic_search(dtxsid = "DTXSID7020182"))), silent = TRUE)
