...
testthat::test_that("chemi_services_smirks2rxn completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_services_smirks2rxn"]]
  ...
  result <- do.call(ComptoxR::chemi_services_smirks2rxn, contract$inputs)
