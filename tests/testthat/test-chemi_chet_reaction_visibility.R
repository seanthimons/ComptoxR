# Tests for chemi_chet_reaction_visibility
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_chet_reaction_visibility passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_chet_reaction_visibility(reaction_id = 1L, internal_only = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "reaction/visibility")
