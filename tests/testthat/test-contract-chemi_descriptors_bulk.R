...
testthat::test_that("chemi_descriptors_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-descriptors.rds"))[["chemi_descriptors_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_descriptors_bulk, contract$inputs)
