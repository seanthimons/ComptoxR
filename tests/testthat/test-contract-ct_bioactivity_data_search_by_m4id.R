...
testthat::test_that("ct_bioactivity_data_search_by_m4id completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_bioactivity_data_search_by_m4id"
  ]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_data_search_by_m4id, contract$inputs)
