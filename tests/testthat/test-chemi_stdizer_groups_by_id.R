# Tests for chemi_stdizer_groups_by_id
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_stdizer_groups_by_id passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_stdizer_groups_by_id(id = "DTXSID7020182"))), silent = TRUE)
