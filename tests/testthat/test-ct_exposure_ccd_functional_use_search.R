...
test_that("ct_exposure_ccd_functional_use_search passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_exposure_ccd_functional_use_search(dtxsid = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "exposure/ccd/functional-use/search/by-dtxsid/")
