...
testthat::test_that("chemi_amos_list_sources_by_record_type completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/apipak/chemi-amos.rds"))[["chemi_amos_list_sources_by_record_type"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_list_sources_by_record_type, contract$inputs)
