...
testthat::test_that("ct_chemical_list_type completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["ct_chemical_list_type"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_list_type, contract$inputs)
