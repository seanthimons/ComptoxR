...
test_that("ct_chemical_property_experimental_search_by_range passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_chemical_property_experimental_search_by_range(propertyName = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "chemical/property/experimental/search/by-range/")
