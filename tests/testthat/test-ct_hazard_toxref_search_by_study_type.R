...
test_that("ct_hazard_toxref_search_by_study_type passes request metadata to helper", {
  ...
  expect_equal(call[["endpoint"]], "hazard/toxref/summary/search/by-study-type/")
