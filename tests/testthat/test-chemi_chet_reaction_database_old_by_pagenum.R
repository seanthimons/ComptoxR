# Tests for chemi_chet_reaction_database_old_by_pagenum
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_chet_reaction_database_old_by_pagenum passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_chet_reaction_database_old_by_pagenum(pagenum = 1L))), silent = TRUE)
