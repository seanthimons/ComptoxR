# Tests for chemi_amos_mass_spectra_for_substances_development
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_mass_spectra_for_substances_development passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_mass_spectra_for_substances_development())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "amos/mass_spectra_for_substances/")
