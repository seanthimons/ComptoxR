...
testthat::test_that("chemi_opera completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-opera.rds"))[["chemi_opera"]]
  ...
  result <- do.call(ComptoxR::chemi_opera, contract$inputs)
