...
testthat::test_that("chemi_stdizer_workflows completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_stdizer_workflows"]]
  ...
  result <- do.call(ComptoxR::chemi_stdizer_workflows, contract$inputs)
