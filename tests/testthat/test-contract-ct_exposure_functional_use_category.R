...
testthat::test_that("ct_exposure_functional_use_category completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_exposure_functional_use_category"]]
  ...
  result <- do.call(ComptoxR::ct_exposure_functional_use_category, contract$inputs)
