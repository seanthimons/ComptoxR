...
testthat::test_that("chemi_stdizer completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-stdizer.rds"))[["chemi_stdizer"]]
  ...
  result <- do.call(ComptoxR::chemi_stdizer, contract$inputs)
