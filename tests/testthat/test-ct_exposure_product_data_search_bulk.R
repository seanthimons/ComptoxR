# Tests for ct_exposure_product_data_search_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("ct_exposure_product_data_search_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_exposure_product_data_search_bulk(query = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "exposure/product-data/search/by-dtxsid/")
