...
test_that("chemi_resolver_resolve passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_resolver_resolve())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "resolver/resolve")
