...
testthat::test_that("chemi_descriptors completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-descriptors.rds"))[["chemi_descriptors"]]
  ...
  result <- do.call(ComptoxR::chemi_descriptors, contract$inputs)
