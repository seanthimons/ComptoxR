# Tests for ct_bioactivity_data_search_by_m4id_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("ct_bioactivity_data_search_by_m4id_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_bioactivity_data_search_by_m4id_bulk(query = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "bioactivity/data/search/by-m4id/")
