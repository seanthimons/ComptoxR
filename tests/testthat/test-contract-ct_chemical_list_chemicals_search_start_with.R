...
testthat::test_that("ct_chemical_list_chemicals_search_start_with completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/apipak/ctx.rds"))[["ct_chemical_list_chemicals_search_start_with"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_list_chemicals_search_start_with, contract$inputs)
