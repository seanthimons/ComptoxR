# Tests for chemi_amos_for_document_ids
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_for_document_ids passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_amos_for_document_ids(record_type = "DTXSID7020182"))),
    silent = TRUE
  )
