...
testthat::test_that("ct_hazard_genetox_details_search_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_hazard_genetox_details_search_bulk"]]
  ...
  result <- do.call(ComptoxR::ct_hazard_genetox_details_search_bulk, contract$inputs)
