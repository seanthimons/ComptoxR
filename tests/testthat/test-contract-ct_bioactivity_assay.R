...
testthat::test_that("ct_bioactivity_assay completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["ct_bioactivity_assay"]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_assay, contract$inputs)
