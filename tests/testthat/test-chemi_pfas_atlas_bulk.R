# Tests for chemi_pfas_atlas_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_pfas_atlas_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_pfas_atlas_bulk(smiles = "CCCC"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "pfas_atlas")
