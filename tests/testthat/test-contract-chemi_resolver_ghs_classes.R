...
testthat::test_that("chemi_resolver_ghs_classes completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-resolver.rds"))[["chemi_resolver_ghs_classes"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_ghs_classes, contract$inputs)
