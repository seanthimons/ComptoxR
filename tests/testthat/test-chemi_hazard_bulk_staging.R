# Tests for chemi_hazard_bulk_staging
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_hazard_bulk_staging passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_hazard_bulk_staging(query = "DTXSID7020182"))),
    silent = TRUE
  )
