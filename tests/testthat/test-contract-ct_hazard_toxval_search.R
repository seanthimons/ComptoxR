...
testthat::test_that("ct_hazard_toxval_search completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_hazard_toxval_search"]]
  ...
  result <- do.call(ComptoxR::ct_hazard_toxval_search, contract$inputs)
