...
testthat::test_that("chemi_pfas_atlas_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_pfas_atlas_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_pfas_atlas_bulk, contract$inputs)
