...
test_that("chemi_toxprints_toxprints_categories passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_toxprints_toxprints_categories())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "toxprints/toxprints_categories")
