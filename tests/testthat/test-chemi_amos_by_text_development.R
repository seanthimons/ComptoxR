# Tests for chemi_amos_by_text_development
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_by_text_development passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_by_text_development(substr = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "amos/search_by_text/")
