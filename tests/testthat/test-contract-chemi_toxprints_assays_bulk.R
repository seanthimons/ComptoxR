...
testthat::test_that("chemi_toxprints_assays_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-toxprints.rds"))[["chemi_toxprints_assays_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_toxprints_assays_bulk, contract$inputs)
