...
testthat::test_that("chemi_amos_spectrum_count_for_methodology completes the fixed call sequence", {
  ...
  result <- do.call(ComptoxR::chemi_amos_spectrum_count_for_methodology, contract$inputs)
