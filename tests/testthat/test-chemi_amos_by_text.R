...
test_that("chemi_amos_by_text passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_amos_by_text(substr = "DTXSID7020182"))),
    silent = TRUE
  )
