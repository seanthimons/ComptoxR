...
testthat::test_that("chemi_toxprints_enrichments completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-toxprints.rds"))[["chemi_toxprints_enrichments"]]
  ...
  result <- do.call(ComptoxR::chemi_toxprints_enrichments, contract$inputs)
