...
testthat::test_that("ct_chemical_property_experimental_search_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/apipak/ctx.rds"))[["ct_chemical_property_experimental_search_bulk"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_property_experimental_search_bulk, contract$inputs)
