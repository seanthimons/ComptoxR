...
test_that("ct_hazard_toxref_effects_search passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_hazard_toxref_effects_search(dtxsid = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "hazard/toxref/effects/search/by-dtxsid/")
