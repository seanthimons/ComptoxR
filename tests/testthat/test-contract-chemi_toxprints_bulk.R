...
testthat::test_that("chemi_toxprints_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_toxprints_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_toxprints_bulk, contract$inputs)
