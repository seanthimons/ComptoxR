...
testthat::test_that("chemi_amos_for_document_ids completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_for_document_ids"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_for_document_ids, contract$inputs)
