...
testthat::test_that("chemi_amos_substances_for_ids completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_substances_for_ids"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_substances_for_ids, contract$inputs)
