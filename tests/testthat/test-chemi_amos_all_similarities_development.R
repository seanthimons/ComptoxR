# Tests for chemi_amos_all_similarities_development
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_all_similarities_development passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_all_similarities_development())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "amos/all_similarities_by_dtxsid/")
