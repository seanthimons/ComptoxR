...
test_that("chemi_amos_mass_spectrum_similarity passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_mass_spectrum_similarity())), silent = TRUE)
