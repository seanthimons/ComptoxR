...
testthat::test_that("ct_bioactivity_assay_search_by_aeid_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_bioactivity_assay_search_by_aeid_bulk"]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_assay_search_by_aeid_bulk, contract$inputs)
