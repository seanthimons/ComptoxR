...
testthat::test_that("ct_bioactivity_aop_search_by_toxcast_aeid completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_bioactivity_aop_search_by_toxcast_aeid"
  ]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_aop_search_by_toxcast_aeid, contract$inputs)
