...
testthat::test_that("chemi_amos_max_similarity completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_max_similarity"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_max_similarity, contract$inputs)
