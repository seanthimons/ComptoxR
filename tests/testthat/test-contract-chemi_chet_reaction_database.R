...
testthat::test_that("chemi_chet_reaction_database completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_chet_reaction_database"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_reaction_database, contract$inputs)
