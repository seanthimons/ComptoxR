...
test_that("ct_hazard_toxval_search_by_category passes request metadata to helper", {
  ...
  expect_equal(call[["endpoint"]], "hazard/toxval/search/by-category/")
  expect_equal(call[["method"]], "GET")
  expect_equal(call[["batch_limit"]], 1)
  expect_equal(call[["category"]], "general")
})
