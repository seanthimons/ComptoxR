...
test_that("chemi_amos_get_pdf passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_get_pdf(record_type = "DTXSID7020182"))), silent = TRUE)
