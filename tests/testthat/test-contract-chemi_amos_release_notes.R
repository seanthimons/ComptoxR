...
testthat::test_that("chemi_amos_release_notes completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-pilot-contracts.rds"))[["chemi_amos_release_notes"]]
  captured <- list()
  ...
  result <- do.call(ComptoxR::chemi_amos_release_notes, contract$inputs)
