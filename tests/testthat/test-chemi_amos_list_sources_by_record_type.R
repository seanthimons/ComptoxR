# Tests for chemi_amos_list_sources_by_record_type
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_list_sources_by_record_type passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_list_sources_by_record_type())), silent = TRUE)
