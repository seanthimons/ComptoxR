...
testthat::test_that("chemi_chet_reaction_libraries completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_chet_reaction_libraries"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_reaction_libraries, contract$inputs)
