# Tests for chemi_webtest_predict_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_webtest_predict_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_webtest_predict_bulk(structures = "DTXSID7020182", endpoints = 1L))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "webtest/predict")
