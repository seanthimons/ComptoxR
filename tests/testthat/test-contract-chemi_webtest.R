...
testthat::test_that("chemi_webtest completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-webtest.rds"))[["chemi_webtest"]]
  ...
  result <- do.call(ComptoxR::chemi_webtest, contract$inputs)
