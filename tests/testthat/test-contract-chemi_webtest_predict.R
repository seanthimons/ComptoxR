...
testthat::test_that("chemi_webtest_predict completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-webtest.rds"))[["chemi_webtest_predict"]]
  ...
  result <- do.call(ComptoxR::chemi_webtest_predict, contract$inputs)
