...
test_that("pubchem_synonyms passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::pubchem_synonyms(cid = c(2244L, 6623L), cache = FALSE))), silent = TRUE)
