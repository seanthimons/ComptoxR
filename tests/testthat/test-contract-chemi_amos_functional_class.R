...
testthat::test_that("chemi_amos_functional_class completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_amos_functional_class"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_functional_class, contract$inputs)
