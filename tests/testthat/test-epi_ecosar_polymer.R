...
test_that("epi_ecosar_polymer passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::epi_ecosar_polymer(type = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "ecosar/polymer")
