...
test_that("ct_exposure_ccd_monitoring_data_search passes request metadata to helper", {
  ...
  expect_equal(call[["endpoint"]], "exposure/ccd/monitoring-data/search/by-dtxsid/")
