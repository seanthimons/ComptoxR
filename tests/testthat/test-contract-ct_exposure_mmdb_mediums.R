...
testthat::test_that("ct_exposure_mmdb_mediums completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["ct_exposure_mmdb_mediums"]]
  ...
  result <- do.call(ComptoxR::ct_exposure_mmdb_mediums, contract$inputs)
