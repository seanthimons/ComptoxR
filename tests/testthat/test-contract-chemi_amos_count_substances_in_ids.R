...
testthat::test_that("chemi_amos_count_substances_in_ids completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_count_substances_in_ids"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_count_substances_in_ids, contract$inputs)
