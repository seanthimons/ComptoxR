...
testthat::test_that("chemi_amos_fact_sheet_keyset_pagination completes the fixed call sequence", {
  ...
  result <- do.call(ComptoxR::chemi_amos_fact_sheet_keyset_pagination, contract$inputs)
