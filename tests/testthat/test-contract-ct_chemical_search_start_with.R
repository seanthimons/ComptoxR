...
testthat::test_that("ct_chemical_search_start_with completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["ct_chemical_search_start_with"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_search_start_with, contract$inputs)
