...
testthat::test_that("chemi_stdizer_chemicals completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-stdizer.rds"))[["chemi_stdizer_chemicals"]]
  ...
  result <- do.call(ComptoxR::chemi_stdizer_chemicals, contract$inputs)
