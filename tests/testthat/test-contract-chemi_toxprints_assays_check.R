...
testthat::test_that("chemi_toxprints_assays_check completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_toxprints_assays_check"]]
  ...
  result <- do.call(ComptoxR::chemi_toxprints_assays_check, contract$inputs)
