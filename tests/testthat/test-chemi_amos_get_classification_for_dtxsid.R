...
test_that("chemi_amos_get_classification_for_dtxsid passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_get_classification_for_dtxsid(dtxsid = "DTXSID7020182"))), silent = TRUE)
