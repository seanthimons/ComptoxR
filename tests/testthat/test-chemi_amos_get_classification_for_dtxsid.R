...
test_that("chemi_amos_get_classification_for_dtxsid works without parameters", {
    vcr::use_cassette("chemi_amos_get_classification_for_dtxsid_basic", {
        result <- chemi_amos_get_classification_for_dtxsid()
        {
