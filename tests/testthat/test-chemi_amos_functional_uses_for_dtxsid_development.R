# Tests for chemi_amos_functional_uses_for_dtxsid_development
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_functional_uses_for_dtxsid_development passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_functional_uses_for_dtxsid_development(dtxsid = "DTXSID7020182"))), silent = TRUE)
