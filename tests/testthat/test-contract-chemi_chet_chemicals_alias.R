...
testthat::test_that("chemi_chet_chemicals_alias completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_chet_chemicals_alias"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_chemicals_alias, contract$inputs)
