...
testthat::test_that("chemi_amos_safety_data_sheet_keyset_pagination completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/apipak/chemi-amos.rds"))[[
    "chemi_amos_safety_data_sheet_keyset_pagination"
  ]]
  ...
  result <- do.call(ComptoxR::chemi_amos_safety_data_sheet_keyset_pagination, contract$inputs)
