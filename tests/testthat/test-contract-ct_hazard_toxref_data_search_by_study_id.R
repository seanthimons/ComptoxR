...
testthat::test_that("ct_hazard_toxref_data_search_by_study_id completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_hazard_toxref_data_search_by_study_id"
  ]]
  ...
  result <- do.call(ComptoxR::ct_hazard_toxref_data_search_by_study_id, contract$inputs)
