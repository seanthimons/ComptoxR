...
testthat::test_that("chemi_amos_retrieve_product_declarations completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/apipak/chemi-amos.rds"))[[
    "chemi_amos_retrieve_product_declarations"
  ]]
  ...
  result <- do.call(ComptoxR::chemi_amos_retrieve_product_declarations, contract$inputs)
