...
test_that("chemi_amos_substances_for_ids passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_substances_for_ids())), silent = TRUE)
