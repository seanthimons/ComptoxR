...
test_that("chemi_amos_substances_for_classification passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_substances_for_classification())), silent = TRUE)
