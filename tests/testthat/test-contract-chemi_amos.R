...
testthat::test_that("chemi_amos completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_amos"]]
  ...
  result <- do.call(ComptoxR::chemi_amos, contract$inputs)
