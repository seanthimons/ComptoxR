# Tests for chemi_resolver_safety_flags
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_resolver_safety_flags passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_resolver_safety_flags(query = "DTXSID7020182"))), silent = TRUE)
