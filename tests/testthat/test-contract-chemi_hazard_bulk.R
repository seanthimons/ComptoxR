...
testthat::test_that("chemi_hazard_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-hazard.rds"))[["chemi_hazard_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_hazard_bulk, contract$inputs)
