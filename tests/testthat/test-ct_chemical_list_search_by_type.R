...
test_that("ct_chemical_list_search_by_type passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_chemical_list_search_by_type(type = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "chemical/list/search/by-type/")
