...
testthat::test_that("ct_bioactivity_data_aed_search_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_bioactivity_data_aed_search_bulk"]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_data_aed_search_bulk, contract$inputs)
