...
testthat::test_that("chemi_stdizer_groups_recursive completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-stdizer.rds"))[["chemi_stdizer_groups_recursive"]]
  ...
  result <- do.call(ComptoxR::chemi_stdizer_groups_recursive, contract$inputs)
