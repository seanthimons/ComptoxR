...
testthat::test_that("chemi_amos_record_ids_for_substance completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_record_ids_for_substance"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_record_ids_for_substance, contract$inputs)
