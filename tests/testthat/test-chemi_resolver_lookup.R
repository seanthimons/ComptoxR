# Tests for chemi_resolver_lookup
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_resolver_lookup passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_resolver_lookup(query = "DTXSID7020182"))), silent = TRUE)
