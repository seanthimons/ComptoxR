...
testthat::test_that("chemi_resolver_pubchem_section completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-resolver.rds"))[["chemi_resolver_pubchem_section"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_pubchem_section, contract$inputs)
