...
testthat::test_that("chemi_amos_mass_spectra_for_substances completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/apipak/chemi-amos.rds"))[["chemi_amos_mass_spectra_for_substances"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_mass_spectra_for_substances, contract$inputs)
