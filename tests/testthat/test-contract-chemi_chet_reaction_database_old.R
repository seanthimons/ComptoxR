...
testthat::test_that("chemi_chet_reaction_database_old completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_chet_reaction_database_old"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_reaction_database_old, contract$inputs)
