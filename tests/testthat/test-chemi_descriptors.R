...
test_that("chemi_descriptors passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_descriptors(smiles = "CCCC", type = "DTXSID7020182"))), silent = TRUE)
