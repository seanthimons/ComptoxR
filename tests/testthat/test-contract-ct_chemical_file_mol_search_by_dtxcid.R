...
testthat::test_that("ct_chemical_file_mol_search_by_dtxcid completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[[
    "ct_chemical_file_mol_search_by_dtxcid"
  ]]
  ...
  result <- do.call(ComptoxR::ct_chemical_file_mol_search_by_dtxcid, contract$inputs)
