...
testthat::test_that("ct_hazard_toxval_search_by_category completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_hazard_toxval_search_by_category"
  ]]
  ...
  result <- do.call(ComptoxR::ct_hazard_toxval_search_by_category, contract$inputs)
