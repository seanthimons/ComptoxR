...
testthat::test_that("chemi_amos_find_dtxsids completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_amos_find_dtxsids"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_find_dtxsids, contract$inputs)
