# Tests for chemi_safety_rqcodes_staging
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_safety_rqcodes_staging passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_safety_rqcodes_staging())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "safety/rqcodes")
