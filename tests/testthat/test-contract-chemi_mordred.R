...
testthat::test_that("chemi_mordred completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-mordred.rds"))[["chemi_mordred"]]
  ...
  result <- do.call(ComptoxR::chemi_mordred, contract$inputs)
