...
testthat::test_that("ct_bioactivity_data_aed_search completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_bioactivity_data_aed_search"]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_data_aed_search, contract$inputs)
