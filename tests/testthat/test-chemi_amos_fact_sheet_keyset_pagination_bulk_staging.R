# Tests for chemi_amos_fact_sheet_keyset_pagination_bulk_staging
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_fact_sheet_keyset_pagination_bulk_staging passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_fact_sheet_keyset_pagination_bulk_staging(limit = 1L))), silent = TRUE)
