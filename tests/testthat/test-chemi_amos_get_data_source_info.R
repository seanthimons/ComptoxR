...
test_that("chemi_amos_get_data_source_info passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_get_data_source_info())), silent = TRUE)
