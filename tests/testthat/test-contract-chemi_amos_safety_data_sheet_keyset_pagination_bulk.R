...
testthat::test_that("chemi_amos_safety_data_sheet_keyset_pagination_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/apipak/chemi-amos.rds"))[[
    "chemi_amos_safety_data_sheet_keyset_pagination_bulk"
  ]]
  ...
  result <- do.call(ComptoxR::chemi_amos_safety_data_sheet_keyset_pagination_bulk, contract$inputs)
