...
testthat::test_that("ct_bioactivity_data_search_by_m4id_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_bioactivity_data_search_by_m4id_bulk"]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_data_search_by_m4id_bulk, contract$inputs)
