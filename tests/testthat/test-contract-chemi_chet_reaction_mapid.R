...
testthat::test_that("chemi_chet_reaction_mapid completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_chet_reaction_mapid"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_reaction_mapid, contract$inputs)
