# Tests for chemi_pfas_cats_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_pfas_cats_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_pfas_cats_bulk(chemicals = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "pfas_cats")
