# Tests for ct_chemical_search_by_msready_formula_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("ct_chemical_search_by_msready_formula_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_chemical_search_by_msready_formula_bulk(query = "DTXSID7020182"))), silent = TRUE)
