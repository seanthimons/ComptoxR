...
testthat::test_that("chemi_toxprints_calculate completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-toxprints.rds"))[["chemi_toxprints_calculate"]]
  ...
  result <- do.call(ComptoxR::chemi_toxprints_calculate, contract$inputs)
