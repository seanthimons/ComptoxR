...
testthat::test_that("chemi_stdizer_groups_by_id completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_stdizer_groups_by_id"]]
  ...
  result <- do.call(ComptoxR::chemi_stdizer_groups_by_id, contract$inputs)
