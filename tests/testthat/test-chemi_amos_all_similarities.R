...
test_that("chemi_amos_all_similarities passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_all_similarities())), silent = TRUE)
