...
test_that("chemi_amos_substance_similarity works without parameters", {
    vcr::use_cassette("chemi_amos_substance_similarity_basic", {
        result <- chemi_amos_substance_similarity()
        {
