...
test_that("ct_chemical_list_chemicals_contain works with valid input", 
    {
        vcr::use_cassette("ct_chemical_list_chemicals_contain_query", 
            {
                result <- ct_chemical_list_chemicals_contain(query = "DTXSID7020182")
                {
...
test_that("ct_chemical_list_chemicals_contain handles batch requests", 
    {
        vcr::use_cassette("ct_chemical_list_chemicals_contain_batch", 
            {
                result <- ct_chemical_list_chemicals_contain(query = c("DTXSID7020182", 
                "DTXSID5032381"))
                expect_s3_class(result, "tbl_df")
...
test_that("ct_chemical_list_chemicals_contain handles invalid input gracefully", 
    {
        vcr::use_cassette("ct_chemical_list_chemicals_contain_error", 
            {
                expect_warning(result <- ct_chemical_list_chemicals_contain(query = "INVALID_ID"))
