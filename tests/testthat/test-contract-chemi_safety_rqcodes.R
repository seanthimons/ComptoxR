...
testthat::test_that("chemi_safety_rqcodes completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-safety.rds"))[["chemi_safety_rqcodes"]]
  ...
  result <- do.call(ComptoxR::chemi_safety_rqcodes, contract$inputs)
