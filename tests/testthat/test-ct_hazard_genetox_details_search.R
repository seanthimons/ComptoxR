...
test_that("ct_hazard_genetox_details_search passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_hazard_genetox_details_search(dtxsid = "DTXSID7020182"))), silent = TRUE)
