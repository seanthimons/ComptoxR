# Tests for chemi_toxprints_assays_by_name
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_toxprints_assays_by_name passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_toxprints_assays_by_name(name = "DTXSID7020182"))), silent = TRUE)
