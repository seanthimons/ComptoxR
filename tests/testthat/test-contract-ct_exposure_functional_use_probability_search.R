...
testthat::test_that("ct_exposure_functional_use_probability_search completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_exposure_functional_use_probability_search"
  ]]
  ...
  result <- do.call(ComptoxR::ct_exposure_functional_use_probability_search, contract$inputs)
