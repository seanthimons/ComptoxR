...
testthat::test_that("chemi_search_similar completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_search_similar"]]
  ...
  result <- do.call(ComptoxR::chemi_search_similar, contract$inputs)
