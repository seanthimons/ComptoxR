...
testthat::test_that("chemi_resolver_mesh completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_resolver_mesh"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_mesh, contract$inputs)
