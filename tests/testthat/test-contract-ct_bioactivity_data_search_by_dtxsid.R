...
testthat::test_that("ct_bioactivity_data_search_by_dtxsid completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_bioactivity_data_search_by_dtxsid"
  ]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_data_search_by_dtxsid, contract$inputs)
