...
testthat::test_that("chemi_amos_next_level_classification completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_next_level_classification"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_next_level_classification, contract$inputs)
