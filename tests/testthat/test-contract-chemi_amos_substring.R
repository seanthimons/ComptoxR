...
testthat::test_that("chemi_amos_substring completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[["chemi_amos_substring"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_substring, contract$inputs)
