...
testthat::test_that("ct_chemical_list_search_by_name completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_chemical_list_search_by_name"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_list_search_by_name, contract$inputs)
