...
testthat::test_that("chemi_chet_reaction_searchcounts completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-chet.rds"))[["chemi_chet_reaction_searchcounts"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_reaction_searchcounts, contract$inputs)
