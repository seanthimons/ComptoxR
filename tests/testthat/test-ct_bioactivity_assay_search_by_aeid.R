...
test_that("ct_bioactivity_assay_search_by_aeid passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_bioactivity_assay_search_by_aeid(aeid = 1L))), silent = TRUE)
