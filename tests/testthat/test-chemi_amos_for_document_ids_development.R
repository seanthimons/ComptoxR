# Tests for chemi_amos_for_document_ids_development
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_for_document_ids_development passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_for_document_ids_development(record_type = "DTXSID7020182", search_info = "DTXSID7020182"))), silent = TRUE)
  expect_gt(length(calls), 0L)
  call <- calls[[1L]]
  expect_true(is.list(call))
  expect_equal(call$.helper, "generic_request")
  expect_null(call[["query"]])
  expect_equal(call[["endpoint"]], "amos/search_for_document_ids/")
