...
test_that("chemi_webtest_predict passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_webtest_predict(smiles = "CCCC"))), silent = TRUE)
