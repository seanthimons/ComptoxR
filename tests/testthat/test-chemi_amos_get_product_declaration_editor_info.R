# Tests for chemi_amos_get_product_declaration_editor_info
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_get_product_declaration_editor_info passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_amos_get_product_declaration_editor_info(internal_id = 1L))),
    silent = TRUE
  )
