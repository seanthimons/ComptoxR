# Tests for chemi_amos_get_substances_for_term_development
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_get_substances_for_term_development passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_get_substances_for_term_development(search_term = "DTXSID7020182"))), silent = TRUE)
