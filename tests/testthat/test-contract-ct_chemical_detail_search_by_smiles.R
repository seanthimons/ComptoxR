...
testthat::test_that("ct_chemical_detail_search_by_smiles completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_chemical_detail_search_by_smiles"
  ]]
  ...
  result <- do.call(ComptoxR::ct_chemical_detail_search_by_smiles, contract$inputs)
