...
testthat::test_that("chemi_amos_dtxsids completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_dtxsids"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_dtxsids, contract$inputs)
