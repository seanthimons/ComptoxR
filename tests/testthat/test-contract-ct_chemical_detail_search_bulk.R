...
testthat::test_that("ct_chemical_detail_search_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-pilot-contracts.rds"))[["ct_chemical_detail_search_bulk"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_detail_search_bulk, contract$inputs)
