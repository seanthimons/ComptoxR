...
testthat::test_that("chemi_amos_get_pdf completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_get_pdf"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_get_pdf, contract$inputs)
