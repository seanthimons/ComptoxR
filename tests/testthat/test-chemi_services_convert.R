...
test_that("chemi_services_convert passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_services_convert())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "services/convert")
