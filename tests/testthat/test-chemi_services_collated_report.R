# Tests for chemi_services_collated_report
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_services_collated_report passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_services_collated_report())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "services/collated_report")
