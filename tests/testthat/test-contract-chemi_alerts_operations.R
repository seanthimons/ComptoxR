...
testthat::test_that("chemi_alerts_operations completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-pilot-contracts.rds"))[["chemi_alerts_operations"]]
  captured <- list()
  ...
  result <- do.call(ComptoxR::chemi_alerts_operations, contract$inputs)
