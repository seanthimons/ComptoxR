...
test_that("ct_chemical_file_image_search_by_gsid passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_chemical_file_image_search_by_gsid(gsid = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "chemical/file/image/search/by-gsid/")
