...
test_that("chemi_toxprints_chemicals_categories works without parameters", {
    vcr::use_cassette("chemi_toxprints_chemicals_categories_basic", {
        result <- chemi_toxprints_chemicals_categories()
        {
