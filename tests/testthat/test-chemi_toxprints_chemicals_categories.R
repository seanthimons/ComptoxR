...
test_that("chemi_toxprints_chemicals_categories passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_toxprints_chemicals_categories())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "toxprints/chemicals_categories")
