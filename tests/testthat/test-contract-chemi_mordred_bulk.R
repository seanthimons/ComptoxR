...
testthat::test_that("chemi_mordred_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-mordred.rds"))[["chemi_mordred_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_mordred_bulk, contract$inputs)
