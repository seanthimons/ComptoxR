...
testthat::test_that("chemi_amos_method_keyset_pagination completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_method_keyset_pagination"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_method_keyset_pagination, contract$inputs)
