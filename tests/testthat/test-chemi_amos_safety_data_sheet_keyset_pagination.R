# Tests for chemi_amos_safety_data_sheet_keyset_pagination
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_safety_data_sheet_keyset_pagination passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_amos_safety_data_sheet_keyset_pagination(limit = 1L))),
    silent = TRUE
  )
