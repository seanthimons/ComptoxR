...
testthat::test_that("ct_chemical_property_experimental_name completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_chemical_property_experimental_name"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_property_experimental_name, contract$inputs)
