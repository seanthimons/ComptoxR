# Tests for chemi_amos_get_similar_structures_by_identifier_type_and_identifier_development
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_get_similar_structures_by_identifier_type_and_identifier_development passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_get_similar_structures_by_identifier_type_and_identifier_development(identifier_type = "DTXSID7020182"))), silent = TRUE)
