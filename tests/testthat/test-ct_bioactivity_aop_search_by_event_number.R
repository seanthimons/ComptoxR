...
test_that("ct_bioactivity_aop_search_by_event_number passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_bioactivity_aop_search_by_event_number(eventNumber = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "bioactivity/aop/search/by-event-number/")
