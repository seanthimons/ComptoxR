...
testthat::test_that("ct_chemical_file_image_search_by_gsid completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[[
    "ct_chemical_file_image_search_by_gsid"
  ]]
  ...
  result <- do.call(ComptoxR::ct_chemical_file_image_search_by_gsid, contract$inputs)
