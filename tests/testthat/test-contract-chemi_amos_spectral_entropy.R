...
testthat::test_that("chemi_amos_spectral_entropy completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_spectral_entropy"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_spectral_entropy, contract$inputs)
