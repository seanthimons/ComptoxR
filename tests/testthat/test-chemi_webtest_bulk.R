...
test_that("chemi_webtest_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_webtest_bulk(query = "DTXSID7020182"))), silent = TRUE)
