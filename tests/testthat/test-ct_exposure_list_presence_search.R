...
test_that("ct_exposure_list_presence_search passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_exposure_list_presence_search(dtxsid = "DTXSID7020182"))), silent = TRUE)
