...
testthat::test_that("chemi_search_gethazard completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_search_gethazard"]]
  ...
  result <- do.call(ComptoxR::chemi_search_gethazard, contract$inputs)
