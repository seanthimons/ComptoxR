...
testthat::test_that("ct_exposure_mmdb_single_sample_by_medium completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-full-contracts.rds"))[[
    "ct_exposure_mmdb_single_sample_by_medium"
  ]]
  ...
  result <- do.call(ComptoxR::ct_exposure_mmdb_single_sample_by_medium, contract$inputs)
