...
testthat::test_that("chemi_hazard completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-hazard.rds"))[["chemi_hazard"]]
  ...
  result <- do.call(ComptoxR::chemi_hazard, contract$inputs)
