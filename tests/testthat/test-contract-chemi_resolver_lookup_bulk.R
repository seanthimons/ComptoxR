...
testthat::test_that("chemi_resolver_lookup_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-resolver.rds"))[["chemi_resolver_lookup_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_resolver_lookup_bulk, contract$inputs)
