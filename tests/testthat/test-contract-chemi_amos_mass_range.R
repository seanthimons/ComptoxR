...
testthat::test_that("chemi_amos_mass_range completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_mass_range"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_mass_range, contract$inputs)
