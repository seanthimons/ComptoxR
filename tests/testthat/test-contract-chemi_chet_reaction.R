...
testthat::test_that("chemi_chet_reaction completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_chet_reaction"]]
  ...
  result <- do.call(ComptoxR::chemi_chet_reaction, contract$inputs)
