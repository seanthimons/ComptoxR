...
testthat::test_that("chemi_amos_method_with_spectra completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_method_with_spectra"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_method_with_spectra, contract$inputs)
