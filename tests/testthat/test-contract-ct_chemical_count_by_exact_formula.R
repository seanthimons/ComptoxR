...
testthat::test_that("ct_chemical_count_by_exact_formula completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_chemical_count_by_exact_formula"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_count_by_exact_formula, contract$inputs)
