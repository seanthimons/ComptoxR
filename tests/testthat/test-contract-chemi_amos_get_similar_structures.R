...
testthat::test_that("chemi_amos_get_similar_structures completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_get_similar_structures"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_get_similar_structures, contract$inputs)
