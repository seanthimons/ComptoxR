# Tests for chemi_amos_functional_class
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_functional_class passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_amos_functional_class(functional_class = "DTXSID7020182"))),
    silent = TRUE
  )
