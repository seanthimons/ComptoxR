...
testthat::test_that("ct_bioactivity_data_summary_search_by_dtxsid completes the fixed call sequence", {
  ...
  result <- do.call(ComptoxR::ct_bioactivity_data_summary_search_by_dtxsid, contract$inputs)
