...
testthat::test_that("ct_bioactivity_search_equal completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["ct_bioactivity_search_equal"]]
  ...
  result <- do.call(ComptoxR::ct_bioactivity_search_equal, contract$inputs)
