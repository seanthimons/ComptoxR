...
testthat::test_that("chemi_amos_retrieve_safety_data_sheets completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/apipak/chemi-amos.rds"))[["chemi_amos_retrieve_safety_data_sheets"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_retrieve_safety_data_sheets, contract$inputs)
