...
test_that("chemi_search_lookup passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_search_lookup())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "search/lookup")
