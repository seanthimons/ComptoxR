# Tests for chemi_amos_count_substances_in_ids_development
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_amos_count_substances_in_ids_development passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_amos_count_substances_in_ids_development())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "amos/count_substances_in_ids/")
