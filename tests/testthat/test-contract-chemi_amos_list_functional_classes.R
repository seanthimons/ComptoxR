...
testthat::test_that("chemi_amos_list_functional_classes completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-amos.rds"))[["chemi_amos_list_functional_classes"]]
  ...
  result <- do.call(ComptoxR::chemi_amos_list_functional_classes, contract$inputs)
