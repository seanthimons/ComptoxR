...
testthat::test_that("chemi_opera_bulk completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/chemi-opera.rds"))[["chemi_opera_bulk"]]
  ...
  result <- do.call(ComptoxR::chemi_opera_bulk, contract$inputs)
