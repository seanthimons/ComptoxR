...
testthat::test_that("ct_chemical_list_chemicals_search_equal completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill/ctx.rds"))[["ct_chemical_list_chemicals_search_equal"]]
  ...
  result <- do.call(ComptoxR::ct_chemical_list_chemicals_search_equal, contract$inputs)
