# Tests for chemi_stdizer_groups_bulk
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_stdizer_groups_bulk passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_stdizer_groups_bulk())), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "stdizer/groups")
