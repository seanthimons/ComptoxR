...
test_that("ct_exposure_ccd_chem_weight_fractions_search passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_exposure_ccd_chem_weight_fractions_search(dtxsid = "DTXSID7020182"))), silent = TRUE)
  ...
  expect_equal(call[["endpoint"]], "exposure/ccd/chem-weight-fractions/search/by-dtxsid/")
