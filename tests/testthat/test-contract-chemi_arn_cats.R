...
testthat::test_that("chemi_arn_cats completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[["chemi_arn_cats"]]
  ...
  result <- do.call(ComptoxR::chemi_arn_cats, contract$inputs)
