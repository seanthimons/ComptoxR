# Tests for chemi_alerts_staging
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_alerts_staging passes request metadata to helper", {
  ...
  result <- try(
    suppressWarnings(suppressMessages(ComptoxR::chemi_alerts_staging(query = "DTXSID7020182"))),
    silent = TRUE
  )
  ...
  expect_equal(call[["endpoint"]], "alerts")
