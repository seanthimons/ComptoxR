# Tests for chemi_predictor_models_predict
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("chemi_predictor_models_predict passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_predictor_models_predict(model_id = 1L))), silent = TRUE)
