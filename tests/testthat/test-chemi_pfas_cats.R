...
test_that("chemi_pfas_cats passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::chemi_pfas_cats(smiles = "CCCC"))), silent = TRUE)
