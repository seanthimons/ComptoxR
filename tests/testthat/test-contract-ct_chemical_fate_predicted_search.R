...
testthat::test_that("ct_chemical_fate_predicted_search completes the fixed call sequence", {
  contract <- readRDS(testthat::test_path("fixtures/specmill-rebuild-contracts.rds"))[[
    "ct_chemical_fate_predicted_search"
  ]]
  ...
  result <- do.call(ComptoxR::ct_chemical_fate_predicted_search, contract$inputs)
