# Tests for ct_bioactivity_data_summary_search_by_aeid
# Generated by dev/generate_tests.R; do not edit by hand.
# Generator: offline wrapper contract tests

test_that("ct_bioactivity_data_summary_search_by_aeid passes request metadata to helper", {
  ...
  result <- try(suppressWarnings(suppressMessages(ComptoxR::ct_bioactivity_data_summary_search_by_aeid(aeid = 1L))), silent = TRUE)
